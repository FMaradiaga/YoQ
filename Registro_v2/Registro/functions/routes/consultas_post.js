...
consultas_post.post('/1004', (request, response) => {//consulta de set de comercio parte 2
  ...
  const Variables = {
    ...
    horario_esta: {
      lunes: {
        apertura: request.body.vcomer_laper,
        cierre: request.body.vcomer_lcier
      },
      martes: {
        apertura: request.body.vcomer_maper,
        cierre: request.body.vcomer_mcier
      },
      miercoles: {
        apertura: request.body.vcomer_miaper,
        cierre: request.body.vcomer_micier
      },
      jueves: {
        apertura: request.body.vcomer_japer,
        cierre: request.body.vcomer_jcier
      },
      viernes: {
        apertura: request.body.vcomer_vaper,
        cierre: request.body.vcomer_vcier
      },
      sabado: {
        apertura: request.body.vcomer_saper,
        cierre: request.body.vcomer_scier
      },
      domingo: {
        apertura: request.body.vcomer_daper,
