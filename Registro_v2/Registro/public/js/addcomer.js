        ...
        complete: function (data) {
           ...
           // location.href = '/1003?idDoc=' + data.responseJSON.Variables.IdDoc + '';
            ...
            $.ajax({
                ...
                type: "POST",
                data: {
                    id: data.responseJSON.Variables.id,
                    name: data.responseJSON.Variables.nombre,
                },
