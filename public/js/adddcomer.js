...
$(document).ready(function () {
    ...
    console.log("dentro del adddcomer");
...
$("#addComercioDg").submit(function (e) {
    ...
    $.ajax({
        ...
        beforeSend: function () {
            ...
            $('body').append("<div class='container'><div class='row center'> <div id='preload_addcomer' class='main-loader'><div class='preloader-wrapper big active'><div class='spinner-layer spinner-blue-only'><div class='circle-clipper left'><div class='circle'></div></div><div class='gap-patch'><div class='circle'></div></div><div class='circle-clipper'><div class='circle'></div></div></div></div>Procesando...</div></div></div>");        
        },
        ...
        complete: function (data) {
            $('body').append("<div id='alertsaved' class='as-container'><div class='as-choice-card'><i class='material-icons'>check</i><h4 class='as-card-title'>REGISTRO GUARDADO</h4> <p class='as-card-info'>Los datso del Formulario se guardaron con exito.</p><div class='card-action'><a href='/1002' class='as-card-cta'><li class='material-icons'>add</li>Nuevo Establecimiento<i class='fas fa-arrow-right'></i></a></div></div></div>");
            $('#previous3').hide();
            $('#btn_submit').hide();
            //quitar el Preload
